...
@section('title', 'Редактирование ' . $destitute->full_name)
    ...
    <section class="tooltip-validations" id="tooltip-validation">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="post" action="{{ route('destitute.update', $destitute->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row g-1">

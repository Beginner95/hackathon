...
@section('title', 'Редактирование ' . $sonko->title)
    ...
    <section class="tooltip-validations" id="tooltip-validation">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="post" action="{{ route('sonko.update', $sonko->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row g-1">
